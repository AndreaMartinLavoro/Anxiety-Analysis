...
Tra i vari argomenti dei post, quale è il dominante?
```{r echo = FALSE , warning=FALSE}
anxiety = 0
stress = 0
domesticviolence = 0
...
creo la matrice e la mostro grficamente con un barplot
```{r echo = TRUE , warning=FALSE}
...
<h3>Quale è il volto dell'ansia?</h3>
...
<h3>Questo è il codice che ha generato l'immagine qui sopra:</h3>
```{}
Table table;
int gridSize = 100;
int iterations = 12;
